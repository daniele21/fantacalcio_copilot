...
function TabsList({
  ...
  return (
      <TabsPrimitive.List
        data-slot="tabs-list"
        className={cn(
          "bg-base-200 text-content-100 inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",
          className
        )}
        {...props}
      />
...
function TabsContent({
  ...
  return (
      <TabsPrimitive.Content
        ...
        className={cn("bg-base-100 text-content-100 flex-1 outline-none", className)}
        {...props}
      />
  )
}
